\begin{tikzpicture}
    ...
    \draw[thick] (1.25,2.00) circle (.15) node[align=center] {\textbf{1}};
    \draw[opacity=0.4, fill=blue, draw=white] (2.25, 2.00) circle[radius=0.15];
    \draw[thick] (2.25,2.00) circle (.15) node[align=center] {\textbf{2}};
    \draw[opacity=0.4, fill=red, draw=white] (2.75, 2.00) circle[radius=0.15];
    \draw[thick] (2.75,2.00) circle (.15) node[align=center] {\textbf{3}};
    \draw[opacity=0.4, fill=red, draw=white] (3.75, 2.00) circle[radius=0.15];
    \draw[thick] (3.75,2.00) circle (.15) node[align=center] {\textbf{4}};
\end{tikzpicture}
