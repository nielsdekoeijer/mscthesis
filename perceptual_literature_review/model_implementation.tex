...
% To allow for a more compact notation, following matrices and vectors are introduced:
% \begin{equation}
...
% \begin{align}
%     D(x[n],\varepsilon[n]) &= C_s L_\text{eff}\sum_{i=0}^{N_g} 
%         \frac{\norm[2][2]{\mat{H}_\text{om}\mat{\Gamma}_i\vecsymbol{\mathcal{E}}}}
%         {\norm[2][2]{\mat{H}_\text{om}\mat{\Gamma}_i\vec{X}} + C_a} \\
%                            &= \sum_{i=0}^{N_g} 
%         \norm[2][2]{\left(\sqrt{\frac{C_s L_\text{eff}}{\norm[2][2]{\mat{H}_\text{om}\mat{\Gamma}_i\vec{X}} + C_a}}\right)
%         \mat{H}_\text{om}\mat{\Gamma}_i\vecsymbol{\mathcal{E}}} \\
%                            &= \sum_{i=0}^{N_g} \norm[2][2]{\mat{W}_i\vecsymbol{\mathcal{E}}} 
% \end{align}
% Here, diagonal matrix $\mat{W}_i$ is defined as follows: 
% \begin{align}
%     \mat{W}_i &= \left(\sqrt{\frac{C_s L_\text{eff}}{\norm[2][2]{\mat{H}_\text{om}\mat{\Gamma}_i\vec{X}} + C_a}}\right)\mat{H}_\text{om}\mat{\Gamma}_i
% \end{align}
% This can be made more compact by rewriting the expression as follows:
% \begin{align}
%     D(x[n],\varepsilon[n]) &= \sum_{i=0}^{N_g} \vecsymbol{\mathcal{E}}\herm\mat{W}_i\herm\mat{W}_i\vecsymbol{\mathcal{E}} \\
%                            &= \vecsymbol{\mathcal{E}}\herm\left(\sum_{i=0}^{N_g} \mat{W}_i\herm\mat{W}_i\right)\vecsymbol{\mathcal{E}} \\
%                            &= \norm[2][2]{\mat{W}\vecsymbol{\mathcal{E}}} 
% \end{align}
% Here, diagonal matrix $\mat{W}$ is defined as follows: 
% \begin{equation}
%     \sqrt{\left(\sum_{i=0}^{N_g} \mat{W}_i\herm\mat{W}_i\right)}
% \end{equation}
% The square root operation is taken element-wise.
% This is possible as the $\mat{W}_i$ matrices are diagonal.
